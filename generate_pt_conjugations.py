...
<body>
  ...
  <p class="hint">Tap/click a verb row to open sample sentences in a panel (vocabulary matched to that verb’s CEFR level).
...
function openExSheet(r, tr) {{
  ...
  exSub.textContent = `${{r.level}} · ${{r.en}} · sample sentences`;
